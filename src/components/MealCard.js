  ...
  return (
    ...
    >
      ...
      <div className={`w-full bg-${color}-300`}>
        <h3 className="font-bold text-2xl pl-3" data-testid="mealcard-title">{meal.strMeal}</h3>
      </div>
      <div className="w-full flex justify-center mt-3" data-testid="mealcard-link">
